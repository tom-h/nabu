...
class ItemProvider < OAI::Provider::Base
  ...
  source_model OAI::Provider::ActiveRecordWrapper.new(::Item.publicly_accessible.includes(:essences, :subject_languages, :content_languages, :countries, :access_condition, :collector, item_agents: [:user, :agent_role]), :limit => 100, :timestamp_field => 'items.updated_at')
